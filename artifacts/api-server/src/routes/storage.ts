...
// Public router: only endpoints that require no session
const router: IRouter = Router();
// Protected router: session + household required (mounted separately)
 ...
 */
privateRouter.post("/storage/uploads/request-url", async (req: Request, res: Response) => {
...
export { privateRouter as storagePrivateRouter };
