...
- Name: group-gates.spec.ts >> WhatsApp group gates >> group_mutation_blocked: "apaga" verb — reply to group JID with blocked body
...
Received string:    "whatsapp:+55992859138001"
```
