...
- Name: group-gates.spec.ts >> WhatsApp group gates >> group_mutation_blocked: "da-pra-criar-modal" verb — reply to group JID with blocked body
...
Received string:    "whatsapp:+55992869957001"
```
