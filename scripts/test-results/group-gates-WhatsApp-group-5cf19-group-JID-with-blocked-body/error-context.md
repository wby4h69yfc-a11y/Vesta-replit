...
- Name: group-gates.spec.ts >> WhatsApp group gates >> group_mutation_blocked: "muda" verb — reply to group JID with blocked body
...
Received string:    "whatsapp:+55992865658001"
```
