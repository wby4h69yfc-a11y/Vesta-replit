...
- Name: group-gates.spec.ts >> WhatsApp group gates >> group_mutation_blocked: "pode-cancelar-modal" verb — reply to group JID with blocked body
...
Received string:    "whatsapp:+55992867803001"
```
